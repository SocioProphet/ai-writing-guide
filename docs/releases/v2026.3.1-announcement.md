...
This release adds artifact discovery (`aiwg index`), forensics agent hardening, crash-resilient Ralph loops, `.aiwg/` version tracking, and a full documentation accuracy sweep.
...
- **Added**: State cleanup for completed Ralph loops — no more stale state files
